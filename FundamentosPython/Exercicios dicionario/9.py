...
class Game:
    ...
    def loop(self):
        ...
        while self.running:
            ...
            for square in self.squares:
                pygame.draw.rect(self.screen, self.roxo, square)
    ...
    def draw_button(self, text):
        pygame.draw.ellipse(self.screen, self.bluewater, self.button)
